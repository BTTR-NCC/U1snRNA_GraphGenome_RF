#Based on U1analysis.random.forest_modeleval_list.U1est.v1.1.py for github
##source /home/ha6434/virturalenv3.7.17_OS8/scikitlearn/bin/activate
import argparse
import os
import random
import pandas as pd
...
trainlistF = args.listF   ##trainlistF = "/home/ha6434/command/leafcutter/list/20241118_U1est.CV.20230831_ICGC-MAGIC-SHH.v2.txt"
seed = args.seed ##outtag = "/home/ha6434/command/leafcutter/output/20220604_MB-SHH/20220604_MB-SHH_logef1.5_FDR0.1_psitable_TRth10ASth6_400x221_corrected_RFinput"
outtag = args.output ##outtag = "/home/ha6434/command/leafcutter/output/20220604_MB-SHH/20220604_MB-SHH_logef1.5_FDR0.1_psitable_TRth10ASth6_400x221_corrected_RFinput"
